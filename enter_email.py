...
class EnterEmail(QWidget):
    ...
    def layout_managment(self):
        ...
        vertical_layout.addStretch(1)
        vertical_layout.addLayout(self.layouts["numeric"], stretch=1)
        vertical_layout.addLayout(self.layouts["first_row"], stretch=1)
        vertical_layout.addLayout(self.layouts["second_row"], stretch=1)
        vertical_layout.addLayout(self.layouts["third_row"], stretch=1)
