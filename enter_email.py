...
class EnterEmail(QWidget):
    ...
    def layout_managment(self):
        ...
        vertical_layout.addStretch(1)
        vertical_layout.addLayout(self.layouts["numeric"], strech=1)
        vertical_layout.addLayout(self.layouts["first_row"], strech=1)
        vertical_layout.addLayout(self.layouts["second_row"], strech=1)
        vertical_layout.addLayout(self.layouts["third_row"], strech=1)
