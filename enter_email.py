...
class EnterEmail(QWidget):
    ...
    def layout_managment(self):
        ...
        vertical_layout.addStretch(1)
        vertical_layout.addLayout(self.layouts["numeric"], 5)
        vertical_layout.addLayout(self.layouts["first_row"], 5)
        vertical_layout.addLayout(self.layouts["second_row"], 5)
        vertical_layout.addLayout(self.layouts["third_row"], 5)
